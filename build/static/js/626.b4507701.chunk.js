/*! For license information please see 626.b4507701.chunk.js.LICENSE.txt */
"use strict";
  ...
  [626],
  {
    626: (e, t, n) => {
      ...
      var i = n(7150),
        o = n(7700),
        a = n(8812);
      const r = "type.googleapis.com/google.protobuf.Int64Value",
        s = "type.googleapis.com/google.protobuf.UInt64Value";
      function c(e, t) {
        const n = {};
        for (const i in e) e.hasOwnProperty(i) && (n[i] = t(e[i]));
        return n;
      }
      function u(e) {
      ...
      class p extends o.g {
        constructor(e, t, n) {
          super("".concat(h, "/").concat(e), t || ""), (this.details = n);
        }
      }
      class f {
        constructor(e, t, n) {
        ...
        async getAuthToken() {
          if (this.auth)
            try {
              ...
              return null === e || void 0 === e ? void 0 : e.accessToken;
            } catch (e) {
              return;
            }
        }
      ...
      class m {
        constructor(e, t, n, i) {
          ...
          (this.app = e),
            ...
            (this.contextProvider = new f(t, n, i)),
            (this.cancelAllRequests = new Promise((e) => {
              this.deleteService = () => Promise.resolve(e());
            }));
          try {
            const e = new URL(o);
            (this.customDomain = e.origin), (this.region = g);
          } catch (r) {
        ...
        _url(e) {
          ...
          return null !== this.customDomain
            ? "".concat(this.customDomain, "/").concat(e)
            : "https://"
                .concat(this.region, "-")
                .concat(t, ".cloudfunctions.net/")
                .concat(e);
        }
      }
      function k(e, t, n) {
      ...
      async function w(e, t, n, i) {
        ...
        return { status: o.status, json: a };
      }
      async function T(e, t, n, i) {
        const o = { data: (n = u(n)) },
          a = {},
          r = await e.contextProvider.getContext(i.limitedUseAppCheckTokens);
        r.authToken && (a.Authorization = "Bearer " + r.authToken),
          r.messagingToken &&
            (a["Firebase-Instance-ID-Token"] = r.messagingToken),
          null !== r.appCheckToken &&
            (a["X-Firebase-AppCheck"] = r.appCheckToken);
        const s = (function (e) {
            let t = null;
            return {
              promise: new Promise((n, i) => {
                t = setTimeout(() => {
                  i(new p("deadline-exceeded", "deadline-exceeded"));
                }, e);
              }),
              cancel: () => {
                t && clearTimeout(t);
        ...
        if ((s.cancel(), !c))
          throw new p("cancelled", "Firebase Functions instance was deleted.");
        const h = (function (e, t) {
          ...
          try {
            ...
            if (e) {
              const t = e.status;
              if ("string" === typeof t) {
                if (!d[t]) return new p("internal", "internal");
                (i = d[t]), (o = t);
              }
              const a = e.message;
              "string" === typeof a && (o = a),
          ...
          return "ok" === i ? null : new p(i, o, n);
        })(c.status, c.json);
        if (h) throw h;
        if (!c.json)
          throw new p("internal", "Response is not valid JSON object.");
        let f = c.json.data;
        if (
          ("undefined" === typeof f && (f = c.json.result),
          "undefined" === typeof f)
        )
          throw new p("internal", "Response is missing data field.");
        return { data: l(f) };
      }
      ...
      function E() {
        ...
        const n = (0, i.j6)((0, o.Ku)(e), h).getImmediate({ identifier: t }),
          a = (0, o.yU)("functions");
        return (
          a &&
            (function (e, t, n) {
              !(function (e, t, n) {
                e.emulatorOrigin = "http://".concat(t, ":").concat(n);
              })((0, o.Ku)(e), t, n);
            })(n, ...a),
          n
        );
          ...
          new a.uA(
            ...
            (e, t) => {
              ...
              const i = e.getProvider("app").getImmediate(),
                ...
                a = e.getProvider("messaging-internal"),
                r = e.getProvider("app-check-internal");
              return new m(i, o, a, r, n, I);
            },
            "PUBLIC"
...
//# sourceMappingURL=626.b4507701.chunk.js.map
